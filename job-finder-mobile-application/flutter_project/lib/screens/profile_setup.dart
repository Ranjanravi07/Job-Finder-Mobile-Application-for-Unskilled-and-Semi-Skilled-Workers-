...
class ProfileSetupScreen extends StatefulWidget {
  ...
  const ProfileSetupScreen({super.key, this.role = 'worker'});
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(lang == 'ne'
              ? 'प्रोफाइल सफलतापूर्वक सिर्जना गरियो!'
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          lang == 'ne'
              ? (isWorker
                  ? 'कामदार प्रोफाइल सेटअप'
                  : 'रोजगारदाता प्रोफाइल सेटअप')
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              labelText:
                  lang == 'ne' ? 'नाम (अंग्रेजीमा)' : 'Full Name (in English)',
              border:
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text(
            lang == 'ne'
                ? 'कहाँ र कसरी काम गर्न चाहनुहुन्छ?'
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            hint:
                Text(lang == 'ne' ? 'परिचय पत्र छान्नुहोस्' : 'Select ID type'),
            validator: (val) {
              if (val == null || val.isEmpty) {
                return lang == 'ne'
                    ? 'कृपया परिचय पत्रको प्रकार छान्नुहोस्'
            ...
            items: [
              ...
              DropdownMenuItem(
                  value: 'nid',
                  child: Text(lang == 'ne'
                      ? 'राष्ट्रिय परिचयपत्र (NID)'
                      : 'National ID (NID)')),
              DropdownMenuItem(
                  value: 'license',
                  child: Text(
                      lang == 'ne' ? 'सवारी चालक अनुमति' : 'Driving License')),
              DropdownMenuItem(
                  value: 'pan',
            ...
            onChanged: (val) {
              setState(() {
                ...
                _govIdNumberController
                    .clear(); // Clear number when type changes
              });
            },
          ),
          const SizedBox(height: 20),
          ...
          if (_selectedGovIdType != null) ...[
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                fillColor: context.appColors.white,
                hintText:
                    lang == 'ne' ? 'नम्बर प्रविष्ट गर्नुहोस्' : 'Enter number',
              ),
              validator: (val) {
                ...
                final validationError =
                    _validateGovIdNumber(_selectedGovIdType!, val.trim(), lang);
          ...
          FormField<String>(
            validator: (val) {
              if (_govIdImageUrl == null || _govIdImageUrl!.isEmpty) {
                return lang == 'ne'
                    ? 'कृपया परिचय पत्रको फोटो अपलोड गर्नुहोस्'
                      ...
                      child: _govIdImageUrl != null
                          ...
                          : Column(
                              ...
                              children: [
                                ...
                                Text(
                                  lang == 'ne'
                                      ? 'फोटो अपलोड गर्न यहाँ थिच्नुहोस्'
    ...
    switch (type) {
      case 'citizenship':
        if (!RegExp(r'^[a-zA-Z0-9\-\/]+$').hasMatch(num)) {
          return lang == 'ne'
              ? 'नागरिकता नम्बरको ढाँचा मिलेन'
              : 'Invalid Citizenship number format';
        }
        break;
      case 'nid':
      ...
      case 'license':
        if (!RegExp(r'^[a-zA-Z0-9\-]+$').hasMatch(num)) {
          return lang == 'ne'
              ? 'सवारी चालक अनुमति नम्बरको ढाँचा मिलेन'
